...
const Profile = () => {
  ...
  const lastLogin = parseInt(user?.metadata?.lastLoginAt);
  ...
  return (
    <div className="flex justify-center mt-[5%]">
        <div className="relative flex flex-col text-gray-70  rounded-xl bg-clip-border">
      <div className="flex justify-center relative mx-4 mt-4 overflow-hidden text-gray-700  rounded-xl bg-clip-border">
      ...
      <button className="btn btn-outline  hover:bg-[#3b0032]">Update Profile</button>
    </div>
    </div>
  );
};
